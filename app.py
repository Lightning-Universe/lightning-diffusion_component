...
class TrainDeploy(L.LightningFlow):
    def __init__(self):
        ...
        self.prior =  Prior(self.create_data.drive_1, cloud_compute=L.CloudCompute("cpu-medium",disk_size=30))

         # work that trains my model
        self.train_work = Training(cloud_compute=L.CloudCompute("cpu-medium",disk_size=30))
